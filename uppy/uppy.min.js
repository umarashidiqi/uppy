...
(function (global){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}exports.__esModule=!0;var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var i=arguments[t];for(var s in i)Object.prototype.hasOwnProperty.call(i,s)&&(e[s]=i[s])}return e},_Utils=require("../core/Utils"),_Utils2=_interopRequireDefault(_Utils),_Translator=require("../core/Translator"),_Translator2=_interopRequireDefault(_Translator),_namespaceEmitter=require("namespace-emitter"),_namespaceEmitter2=_interopRequireDefault(_namespaceEmitter),_deepFreezeStrict=require("deep-freeze-strict"),_deepFreezeStrict2=_interopRequireDefault(_deepFreezeStrict),_UppySocket=require("./UppySocket"),_UppySocket2=_interopRequireDefault(_UppySocket),_en_US=require("../locales/en_US"),_en_US2=_interopRequireDefault(_en_US),Core=function(){function e(t){_classCallCheck(this,e);var i={locales:_en_US2.default,autoProceed:!0,debug:!1};this.opts=_extends({},i,t),this.types=["presetter","orchestrator","progressindicator","acquirer","modifier","uploader","presenter","debugger"],this.type="core",this.plugins={},this.translator=new _Translator2.default({locales:this.opts.locales}),this.i18n=this.translator.translate.bind(this.translator),this.getState=this.getState.bind(this),this.updateMeta=this.updateMeta.bind(this),this.initSocket=this.initSocket.bind(this),this.log=this.log.bind(this),this.emitter=(0,_namespaceEmitter2.default)(),this.state={files:{}},this.opts.debug&&(global.UppyState=this.state,global.uppyLog="",global.UppyAddFile=this.addFile.bind(this))}return e.prototype.updateAll=function(e){var t=this;Object.keys(this.plugins).forEach(function(i){t.plugins[i].forEach(function(t){t.update(e)})})},e.prototype.setState=function(e){var t=_extends({},this.state,e);this.emitter.emit("state-update",this.state,t,e),this.state=t,this.updateAll(this.state),this.log("Updating state with: "),this.log(t)},e.prototype.getState=function(){return(0,_deepFreezeStrict2.default)(this.state)},e.prototype.updateMeta=function(e,t){var i=_extends({},this.getState().files),s=_extends({},i[t].meta,e);i[t]=_extends({},i[t],{meta:s}),this.setState({files:i})},e.prototype.addFile=function(e){var t=_extends({},this.state.files),i=e.name||"noname",s=_Utils2.default.getFileType(e)?_Utils2.default.getFileType(e).split("/"):["",""],n=s[0],r=s[1],o=_Utils2.default.getFileNameAndExtension(i)[1],a=e.isRemote||!1,l=_Utils2.default.generateFileID(i),u={source:e.source||"",id:l,name:i,extension:o||"",meta:{name:i},type:{general:n,specific:r},data:e.data,progress:{percentage:0,uploadComplete:!1,uploadStarted:!1},size:e.data.size,isRemote:a,remote:e.remote||""};t[l]=u,this.setState({files:t}),this.emitter.emit("file-added",l),"image"!==n||a||this.addFileThumbnail(u.id),this.opts.autoProceed&&this.emitter.emit("core:upload")},e.prototype.addFileThumbnail=function(e,t){var i=this,s=this.getState().files[e];_Utils2.default.readFile(s.data).then(_Utils2.default.createImageThumbnail).then(function(t){var s=_extends({},i.getState().files),n=_extends({},s[e],{preview:t});s[e]=n,i.setState({files:s})})},e.prototype.actions=function(){var e=this,t=this.emitter;t.on("file-add",function(t){e.addFile(t)}),t.on("file-remove",function(t){var i=_extends({},e.getState().files);delete i[t],e.setState({files:i})}),t.on("core:file-upload-started",function(t,i){var s=_extends({},e.getState().files),n=_extends({},s[t],_extends({},{progress:_extends({},s[t].progress,{uploadStarted:Date.now()})}));s[t]=n,e.setState({files:s})}),t.on("upload-progress",function(i){var s=i.id,n=_extends({},e.getState().files);if(!n[s])return void console.error("Trying to set progress for a file that’s not with us anymore: ",s);var r=_extends({},n[s],_extends({},{progress:_extends({},n[s].progress,{bytesUploaded:i.bytesUploaded,bytesTotal:i.bytesTotal,percentage:Math.round((i.bytesUploaded/i.bytesTotal*100).toFixed(2))})}));n[i.id]=r;var o=Object.keys(n).filter(function(e){return!n[e].progress.uploadComplete&&n[e].progress.uploadStarted}),a=100*Object.keys(o).length,l=0;o.forEach(function(e){l+=n[e].progress.percentage});var u=100*l/a;if(100===u){var p=Object.keys(n).filter(function(e){return 100===n[e].progress.percentage});t.emit("all-uploads-complete",p.length)}e.setState({totalProgress:u,files:n})}),t.on("upload-success",function(t,i){var s=_extends({},e.getState().files),n=_extends({},s[t],{progress:_extends({},s[t].progress,{uploadComplete:!0}),uploadURL:i});s[t]=n,e.setState({files:s})}),t.on("core:update-meta",function(t,i){e.updateMeta(t,i)}),"undefined"!=typeof window&&(window.addEventListener("online",function(){return e.isOnline(!0)}),window.addEventListener("offline",function(){return e.isOnline(!1)}),setTimeout(function(){return e.isOnline()},3e3))},e.prototype.isOnline=function(e){var t=this.emitter,i=e||window.navigator.onLine;i?(t.emit("is-online"),this.wasOffline&&(t.emit("informer","Connected!","success",3e3),this.wasOffline=!1)):(t.emit("is-offline"),t.emit("informer","No internet connection","error",0),this.wasOffline=!0)},e.prototype.use=function(e,t){var i=new e(this,t),s=i.id;if(this.plugins[i.type]=this.plugins[i.type]||[],!s)throw new Error("Your plugin must have a name");if(!i.type)throw new Error("Your plugin must have a type");var n=this.getPlugin(s);if(n){var r="Already found a plugin named '"+n.name+"'.\n        Tried to use: '"+s+"'.\n        Uppy is currently limited to running one of every plugin.\n        Share your use case with us over at\n        https://github.com/transloadit/uppy/issues/\n        if you want us to reconsider.";throw new Error(r)}return this.plugins[i.type].push(i),this},e.prototype.getPlugin=function(e){var t=!1;return this.iteratePlugins(function(i){var s=i.id;if(s===e)return t=i,!1}),t},e.prototype.iteratePlugins=function(e){var t=this;Object.keys(this.plugins).forEach(function(i){t.plugins[i].forEach(e)})},e.prototype.log=function(e){this.opts.debug&&(e===""+e?console.log("LOG: "+e):console.dir(e),global.uppyLog=global.uppyLog+"\nDEBUG LOG: "+e)},e.prototype.installAll=function(){var e=this;Object.keys(this.plugins).forEach(function(t){e.plugins[t].forEach(function(e){e.install()})})},e.prototype.run=function(){this.log("Core is run, initializing actions, installing plugins..."),this.actions(),this.plugins.acquirer&&this.plugins.acquirer.length>1&&(this.opts.autoProceed=!1),this.installAll()},e.prototype.initSocket=function(e){return this.socket||(this.socket=new _UppySocket2.default(e)),this.socket},e}();exports.default=Core;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}exports.__esModule=!0,exports.locales=exports.plugins=exports.Core=void 0;var _index=require("./core/index.js"),_index2=_interopRequireDefault(_index),_index3=require("./plugins/index.js"),_index4=_interopRequireDefault(_index3),locales={};exports.Core=_index2.default,exports.plugins=_index4.default,exports.locales=locales;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}exports.__esModule=!0;var _Plugin=require("./Plugin"),_Plugin2=_interopRequireDefault(_Plugin),_index=require("./Dashboard/index.js"),_index2=_interopRequireDefault(_index),_Dummy=require("./Dummy"),_Dummy2=_interopRequireDefault(_Dummy),_DragDrop=require("./DragDrop"),_DragDrop2=_interopRequireDefault(_DragDrop),_Formtag=require("./Formtag"),_Formtag2=_interopRequireDefault(_Formtag),_index3=require("./GoogleDrive/index.js"),_index4=_interopRequireDefault(_index3),_index5=require("./Webcam/index.js"),_index6=_interopRequireDefault(_index5),_ProgressBar=require("./ProgressBar.js"),_ProgressBar2=_interopRequireDefault(_ProgressBar),_Informer=require("./Informer.js"),_Informer2=_interopRequireDefault(_Informer),_Tus=require("./Tus10"),_Tus2=_interopRequireDefault(_Tus),_Multipart=require("./Multipart"),_Multipart2=_interopRequireDefault(_Multipart);exports.default={Plugin:_Plugin2.default,Dummy:_Dummy2.default,ProgressBar:_ProgressBar2.default,Informer:_Informer2.default,DragDrop:_DragDrop2.default,GoogleDrive:_index4.default,Formtag:_Formtag2.default,Tus10:_Tus2.default,Multipart:_Multipart2.default,Dashboard:_index2.default,Webcam:_index6.default};
